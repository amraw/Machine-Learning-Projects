...
def run_bi_glob_model_2(body_length=0, numb_layers=0):
    ...
    fake_nn = models.bi_dir_lstm_model_3(globel_vectors = global_feature_length,headline_length=MAX_HEADLINE_LENGTH,
                                         body_length=MAX_BODY_LENGTH, embedding_dim=EMBEDDING_DIM, word_index=word_index,
    ...
    fake_hist = fake_nn.fit([train_headlines_final, train_bodies_final, train_global], train_stances_final, batch_size=256,
    ...
    result = fake_nn.predict([test_headlines_seq, test_bodies_seq, test_global_feature], batch_size=256)
...
if __name__ == '__main__':
    ...
    run_bi_glob_model_2(body_length, numb_layers)